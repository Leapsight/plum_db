...
new_segment_store(Opts, State) ->
    ...
    N = 1 + WriteBufferMax - WriteBufferMin,
    RandState = rand:seed(exsplus, Now),
    {Offset, _} = rand:uniform_s(N, RandState),
...
snapshot(State) ->
    ...
    %% TODO consider using rocksdb snapshots here!
