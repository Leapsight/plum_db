...
%% proper thing to do would be for make a PR to Ulf so that we can customise
%% the Etag via application environment
...
%% >>>>> OUR ONLY CHANGE HERE
%% -define(ETag, gproc_ps_event).
-define(ETag, plum_db_event).
%% <<<<<
